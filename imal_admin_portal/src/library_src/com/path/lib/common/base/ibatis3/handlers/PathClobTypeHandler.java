 ...
 */
public class PathClobTypeHandler extends BaseTypeHandler<String> {
	private final BaseTypeHandler<Reader> clobReaderTypeHandler;
	  public PathClobTypeHandler() 
	  {
		      this(new PathClobReaderTypeHandler());
		}	
	 public PathClobTypeHandler(BaseTypeHandler<Reader> clobReaderTypeHandler) 
	 {
