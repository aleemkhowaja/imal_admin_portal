/*
 * $Id: JSONUtil.java 799110 2009-07-29 22:44:26Z musachy $
 *
...
/**
 * Wrapper for PathJSONWriter with some utility methods.
 */
public final class PathJSONUtil {
    final static String RFC3339_FORMAT = "yyyy-MM-dd'T'HH:mm:ss:SSS";
    private static final Log LOG = Log.getInstance();

    /**
     * Private constructor only to prevent instantiation in the class
     */
    private PathJSONUtil()
    {
	Log.getInstance().error("This Class Should not be Instantiated");
    }
    
    public static String strutsJsonSerialize(Object object) throws JSONException
    {
	return strutsJsonSerialize(object, null, null, false, true);
    }
    public static String strutsJsonSerialize(Object object, Collection<Pattern> excludeProperties,
            Collection<Pattern> includeProperties, boolean ignoreHierarchy, boolean excludeNullProperties) throws JSONException
    {
    ...
    public static String serialize(Object object) throws JSONException {
        PathJSONWriter writer = new PathJSONWriter();
    ...
    public static Object deserialize(Reader reader) throws JSONException {
        // read content
        PathBufferedReaderSecure bufferReader;
	try
	{
	    bufferReader = new PathBufferedReaderSecure(reader,200000000);
	}
	catch(Exception e1)
	{
	    LOG.error(e1,"Error in deserialize PathJSONUtil "+e1.getMessage());
    ...
    public static void writeJSONToResponse(SerializationParams serializationParams) throws IOException {
        ...
        if (StringUtil.isNotBlank(serializationParams.getSerializedJSON()))
        {
            stringBuilder.append(serializationParams.getSerializedJSON());
        }

        if (StringUtil.isNotBlank(serializationParams.getWrapPrefix()))
        {
        ...
        if (StringUtil.isNotBlank(serializationParams.getWrapSuffix()))
        {
        ...
        if (serializationParams.isGzip()) {
            ...
            try {
                ...
                in = new ByteArrayInputStream(json.getBytes(FileUtil.DEFAULT_FILE_ENCODING));
    ...
    public static Method[] listSMDMethods(Class clazz, boolean ignoreInterfaces) {
        ...
        if (ignoreInterfaces) {
            ...
            // order encountered
            PathJSONUtil.visitInterfaces(clazz, new PathJSONUtil.ClassVisitor() {
    ...
    /// This method is used to validate a JSON string 
